...
### Added
- **Simplified Chinese (beta):** Folio speaks 简体中文 when your phone does, every screen of it, the Market included. On Android 13 and later you can also set Folio's language on its own in Android Settings › Apps › Folio › Language. It's a beta translation until a native speaker has reviewed it; corrections are welcome (see `docs/translating.md`).
